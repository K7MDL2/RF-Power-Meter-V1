...
//#define CIV_Serial SerialUSB2 // for Icom CI-V decoding
    ...
    #char HostIP[] = "192.168.2.62";   // this seems to work best for enet_write() function
...
#define BAND_DEC_IN_1   3  // This example is using 4 wire BCD in my install so not using all 6 defined pins, just 4 with PTT and Gnd on the same Band In connector
...
#define BAND_DEC_A_5    38      
#define BAND_DEC_A_6    39      
#define BAND_DEC_A_7    40     
...
#define BAND_DEC_C_0    10    // not using so set pin to something impossible
#define BAND_DEC_C_1    11    // not using so set pin to something impossible
#define BAND_DEC_C_2    12
#define BAND_DEC_C_3    99
#define BAND_DEC_C_4    99
...
#define PTT_OUT2        41    // Follows PTT IN from Band decoder input and/or OTRSP serial line DTR/RTS.  May have translations applied
#define CW_KEY_OUT      36    // CW is from OTRSP serial line RTS/DTR 
