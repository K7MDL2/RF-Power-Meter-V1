...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE Serial_USB_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE Serial_USB_DEVICE0_CONFIGURATION0_DESCR[67u] = {
...
*********************************************************************/
const uint8 CYCODE Serial_USB_STRING_DESCRIPTORS[177u] = {
/*********************************************************************
...
/* DescriptorType: STRING                  */ 0x03u,
 ...
 (uint8)'r', 0u,
/*********************************************************************
* String Descriptor: "USB RF Wattmeter"
*********************************************************************/
/* Descriptor Length                       */ 0x22u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'U', 0u,(uint8)'S', 0u,(uint8)'B', 0u,(uint8)' ', 0u,(uint8)'R', 0u,
 (uint8)'F', 0u,(uint8)' ', 0u,(uint8)'W', 0u,(uint8)'a', 0u,(uint8)'t', 0u,
 (uint8)'t', 0u,(uint8)'m', 0u,(uint8)'e', 0u,(uint8)'t', 0u,(uint8)'e', 0u,
 (uint8)'r', 0u,
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE Serial_USB_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_Serial_USB_EP_SETTINGS_BLOCK CYCODE Serial_USB_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE Serial_USB_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_Serial_USB_LUT CYCODE Serial_USB_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &Serial_USB_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &Serial_USB_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &Serial_USB_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_Serial_USB_LUT CYCODE Serial_USB_DEVICE0_TABLE[3u] = {
    {0x01u,     &Serial_USB_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &Serial_USB_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_Serial_USB_LUT CYCODE Serial_USB_TABLE[1u] = {
    {0x01u,     &Serial_USB_DEVICE0_TABLE}
};
    ...
    *  Serial_USB_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE Serial_USB_MSOS_DESCRIPTOR[Serial_USB_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   Serial_USB_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE Serial_USB_MSOS_CONFIGURATION_DESCR[Serial_USB_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 Serial_USB_idSerialNumberStringDescriptor[Serial_USB_IDSN_DESCR_LENGTH];
