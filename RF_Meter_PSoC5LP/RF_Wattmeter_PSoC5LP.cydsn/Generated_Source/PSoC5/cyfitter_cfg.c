...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x4800032Cu)

/* UDB_0_0_0_CONFIG Address: CYDEV_UCFG_B1_P5_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000334u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480003B4u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480003E0u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480003E8u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x08u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP0_MX, 0x0104u);
...
uint8 CYXDATA * const CYCODE AMux_RF_Power__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_RF_Power__maskTable[4] = {
	0x02u, 0x20u, 
	0x01u, 0x10u, 
};

/*******************************************************************************
* Function Name: AMux_RF_Power_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void AMux_RF_Power_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_RF_Power__addrTable[channel] |= AMux_RF_Power__maskTable[channel];
		channel++;
		*AMux_RF_Power__addrTable[channel] |= AMux_RF_Power__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: AMux_RF_Power_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void AMux_RF_Power_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_RF_Power__addrTable[channel] &= (uint8)~AMux_RF_Power__maskTable[channel];
		channel++;
		*AMux_RF_Power__addrTable[channel] &= (uint8)~AMux_RF_Power__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ADC_RF_Power_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_RF_Power_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_RF_Power_AMux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void ADC_RF_Power_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_RF_Power_AMux__addrTable[channel] |= ADC_RF_Power_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_RF_Power_AMux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void ADC_RF_Power_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_RF_Power_AMux__addrTable[channel] &= (uint8)~ADC_RF_Power_AMux__maskTable[channel];
	}
}
