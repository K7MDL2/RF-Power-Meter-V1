...
*** V2.4 uploaded to Master Branch on 12/1/2020.   This is the first working port from the PSoC5 to Arduino Teensy 4.1. Initial testing shows the Desktop app fully working, EEPROM working, and most of the Nextion display working. The Nextion Graphing display page causes a display lockup due to a page number detection error causing the CPU to get out of sync with the display.  
