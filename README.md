...
7. Add SPI bus connected HI and LO side driver chip support to expand the IO. Would use TPIC6595N and MIC5891YN driver chips.  Also looking to use optocouplers on the input pins to beef things up if I elect to make PCB.  Would then use edge connectors to minimize internal wiring.
